...
public class EerpmManualConclusion implements BaseConclusion {
  ...
  private EerpmManualConclusionBean bean;
  private String rawJson;

  public EerpmManualConclusion(String json) throws IOException {
    setJson(json);
  }

  @Override
  public TopicType getType() {
    return TopicType.EERPMMANUAL;
  }

  @Override
  public void setJson(String json) throws IOException {
    this.rawJson = json;
    this.bean = mapper.readValue(json, EerpmManualConclusionBean.class);
  }
